...
package com.google.cloud.teleport.v2.templates.spanner.common;
...
public final class Type implements Serializable {
    ...
    private static final Type TYPE_PG_ARRAY_FLOAT8 = new Type(Type.Code.PG_ARRAY, TYPE_PG_FLOAT8, null);
    private static final Type TYPE_PG_ARRAY_VARCHAR = new Type(Type.Code.PG_ARRAY, TYPE_PG_VARCHAR, null);
    private static final Type TYPE_PG_ARRAY_TEXT = new Type(Type.Code.PG_ARRAY, TYPE_PG_TEXT, null);
    private static final Type TYPE_PG_ARRAY_NUMERIC = new Type(Type.Code.PG_ARRAY, TYPE_PG_NUMERIC, null);

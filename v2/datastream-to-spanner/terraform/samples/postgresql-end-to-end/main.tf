...
resource "google_dataflow_flex_template_job" "live_migration_job" {
  ...
  parameters = {
    ...
    shadowTableSpannerInstanceId    = var.dataflow_params.template_params.shadow_table_spanner_instance_id
    shadowTableSpannerDatabaseId    = var.dataflow_params.template_params.shadow_table_spanner_database_id

...
public class SpannerDataWriterTest {
  ...
  public void testRowToMutation_dateMapping() {
    ...
    Mutation mutation = writer.rowToMutation(table, row, MutationType.INSERT);
  ...
  public void testRowToInsertMutation() {
    ...
    Mutation mutation = writer.rowToMutation(table, row, MutationType.INSERT);
    Assert.assertEquals("my_table", mutation.getTable());
    Assert.assertTrue(mutation.toString().contains("my_table"));
  }
  ...
  public void testRowToUpdateMutation() {
    ...
    Mutation mutation = writer.rowToMutation(table, row, MutationType.UPDATE);
    Assert.assertEquals("my_table", mutation.getTable());
    Assert.assertTrue(mutation.toString().contains("my_table"));
  }
  ...
  public void testRowToDeleteMutation() {
    ...
    Mutation mutation = writer.rowToMutation(table, row, MutationType.DELETE);
    Assert.assertEquals("my_table", mutation.getTable());
    Assert.assertTrue(mutation.toString().contains("my_table"));
  }
  ...
  public void testRowToDeleteMutation_missingPk() {
    ...
    Assert.assertThrows(
        IllegalStateException.class, () -> writer.rowToMutation(table, row, MutationType.DELETE));
  }
}

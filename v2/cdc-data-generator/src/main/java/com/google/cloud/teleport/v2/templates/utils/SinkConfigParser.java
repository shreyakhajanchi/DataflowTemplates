...
import com.google.cloud.teleport.v2.spanner.migrations.utils.SpannerConfigFileReader;
...
public class SinkConfigParser {
  ...
  public static SinkConfig parse(SinkType sinkType, String sinkOptionsPath) throws IOException {
    ...
    if (sinkType == SinkType.SPANNER) {
      ...
      SpannerConnectionConfig config = reader.getSpannerConfig(sinkOptionsPath);
      ...
      return new SpannerSinkConfig(projectId, instanceId, databaseId, dialect);
